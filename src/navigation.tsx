...
import { classNames, wbr } from '../node_modules/typedoc/dist/lib/output/themes/lib';
import { partition } from '../node_modules/typedoc/dist/lib/utils';

export const PACKAGE_PREFIX = 'package-prefix';
  ...
  function link(mod: DeclarationReflection) {
    ...
    return (
      <li class={classNames({ current }) + ' ' + mod.cssClasses}>
        <a class="tsd-kind-icon" href={context.urlTo(mod)}>
          {wbr(mod.name)}
        </a>
        {childNav}
      </li>
